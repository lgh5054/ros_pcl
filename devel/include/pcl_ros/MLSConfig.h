...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(MLSConfig::AbstractParamDescriptionConstPtr(new MLSConfig::ParamDescription<int>("spatial_locator", "int", 0, "Set the spatial locator", "{'enum_description': 'Set the spatial locator', 'enum': [{'srcline': 9, 'description': 'ANN', 'srcfile': '/home/nvidia/Library/ros_pcl/src/pcl_ros/cfg/MLS.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'ANN'}, {'srcline': 9, 'description': 'FLANN', 'srcfile': '/home/nvidia/Library/ros_pcl/src/pcl_ros/cfg/MLS.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'FLANN'}, {'srcline': 9, 'description': 'Dense/organized data locator', 'srcfile': '/home/nvidia/Library/ros_pcl/src/pcl_ros/cfg/MLS.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'organized'}]}", &MLSConfig::spatial_locator)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 9 "/home/nvidia/Library/ros_pcl/src/pcl_ros/cfg/MLS.cfg"
      const int MLS_ANN = 0;
//#line 9 "/home/nvidia/Library/ros_pcl/src/pcl_ros/cfg/MLS.cfg"
